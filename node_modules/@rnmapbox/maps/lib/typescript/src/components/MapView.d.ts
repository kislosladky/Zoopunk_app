...
export declare type GestureSettings = {
    /**
...
declare type NativeProps = Omit<Props, 'onPress' | 'onLongPress' | 'onCameraChanged'> & {
...
declare type RNMBXMapViewRefType = Component<NativeProps> & Readonly<NativeMethods>;
