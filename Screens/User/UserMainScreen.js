...
const Achivments = [
  ...
  },
  {
    id: '58694a0f-3da1-471f-bd96-145571e29d72',
    title: 'Достижение3',
    img: require("../../assets/4xPrizeAch.png")
  },
];
...
const AchivementsItem = (props) => (
  <TouchableOpacity activeOpacity={0.9} style={{height: 170, width: 270, margin: 10, borderRadius: 20, elevation: 5}} onPress={() => Alert.alert(props.title)}>
    <ImageBackground source={props.img} style={{width: 270, height: 170}}>
